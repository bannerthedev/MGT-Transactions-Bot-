...
# channels
TRANSACTIONS_ID = 1507163975098568766
MATCH_TIMES_CHANNEL_ID = 1507164179860029510
ASSIGNMENTS_CHANNEL_ID = 1507165682628821002
SCRIM_CATEGORY_ID = 1507177178897584128  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1507164233828405368  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1507138072284758078
CO_CAPTAIN_ROLE_ID = 1507138090240835684
EXECUTIVE_ROLE_ID = 1507138019709423698
TEAM_PLAYER_ROLE_ID = 1507138113913491576

# assignment roles
HEAD_REF_ROLE_ID = 1507177459571757116
REF_ROLE_ID = 1507166428774666371
HEAD_CASTER_ROLE_ID = 1507177441922125854
CASTER_ROLE_ID = 1507166474672934963

FAQ_CHANNEL_ID = 1507176392889208862  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1507177605290262599  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1507177641856335973  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1507177679898542202      # 🎉 Event Ping
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="MGT Transactions Bot – Command Guide",
    ...
    embed.add_field(
        ...
        value="Change the team's captain (e.g. banner1234 to kizzy.lul).",
        inline=False,
    )
    embed.add_field(
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="MGT Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the MGT FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        ...
        "> - We will use <#1498306861043024052> to update you on our team situation! We pick the best teams we can from out forms, so make sure you are active and competitive!\n"
        ...
        "## • Application Forms\n\n"
        "> - MGT has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"MGT{random.randint(1000, 9999)}"
